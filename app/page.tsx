...
export const metadata = {
  title: "BLACKENSYS - Video Streaming & Unlimited Cloud Storage | Official Website",
  description:
    "BLACKENSYS Private Limited offers premium video streaming and unlimited cloud storage solutions. Create, share, monetize, and store all your digital content securely with BLACKENSYS Limited.",
  keywords: [
    "blackensys",
  ...
  alternates: {
    canonical: "https://blackensys.com/",
  },
}
            ...
            <div className="mx-auto grid max-w-5xl grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3 mt-12">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Securely store all your files with end-to-end encryption and access them from anywhere with
                    BLACKENSYS cloud storage.
                  </CardDescription>
                </CardHeader>
                <CardContent>
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Create engaging short-form videos and share them with your audience instantly on BLACKENSYS
                    platform.
                  </CardDescription>
                </CardHeader>
                <CardContent>
            ...
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <h2 className="text-3xl font-bold tracking-tighter sm:text-5xl">
                  Simple & Powerful BLACKENSYS Platform
                </h2>
                <p className="max-w-[900px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
            ...
            <div className="mx-auto grid max-w-5xl grid-cols-1 gap-6 md:grid-cols-3 mt-12">
              ...
              <Card>
                <CardContent className="p-6">
                  ...
                  <p className="text-muted-foreground">
                    "The ad campaign tools are incredibly powerful yet easy to use. We've seen a 3x increase in
                    engagement since switching to this platform. The cloud storage is just an added bonus!"
                  </p>
                </CardContent>
              </Card>
              <Card>
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              alternateName: ["BLACKENSYS", "BLACKENSYS Limited", "Blackensys Limited"],
              ...
              sameAs: [
                ...
                "https://www.youtube.com/blackensys",
              ],
              contactPoint: {
                "@type": "ContactPoint",
                ...
                itemListElement: [
                  {
                    ...
                    itemOffered: {
                      ...
                      description: "Secure cloud storage with unlimited capacity for all your files",
                    },
                  },
                  {
                    "@type": "Offer",
                    itemOffered: {
                      ...
                      description: "Create, share and monetize video content",
                    },
                  },
                ],
              },
